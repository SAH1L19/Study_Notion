...
//resetPassword Token
exports.setPasswordToken = async(req,res)=>{
    try{
        //get email from req
    ...
    const updatedDetails = await User.find({email:email},{token:token},{resetPasswordExpires:Date.now()+5*60*60*1000},{new:true});
